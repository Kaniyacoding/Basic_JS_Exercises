...
function week(day){
    ...
    if (day== 'Friday'){ return 'almost weekend'
    }

    else if (day== 'Saturday' || day== 'Sunday'){ return 'weekend'

    }else if (day== 'Monday' || day== 'Tuesday' || day== 'Wednesday' || day== 'Thursday'){ return 'weekday'
    }
}
